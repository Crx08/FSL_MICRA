...
public class LibroController {
    ...
    public ResponseEntity<?> inserisciCopie(@PathVariable String isbn, @RequestParam(defaultValue = "1") int quantita) {
        ...
        for (int i = 0; i < quantita; i++) {
            ...
            copia.setStatoConservazione("Buono");
            copiaLibroRepository.save(copia);
        }
        return ResponseEntity.ok("Aggiunte " + quantita + " copie per il libro: " + libro.getTitolo());
    }
