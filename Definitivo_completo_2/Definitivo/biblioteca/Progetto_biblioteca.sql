...
('Mario',      'Rossi',     '1985-03-12', 'M', 'mario.rossi@email.com',      '3331234561'),
('Anna',       'Bianchi',   '1990-07-22', 'F', 'anna.bianchi@email.com',     '3331234562'),
('Luca',       'Verdi',     '1978-11-05', 'M', 'luca.verdi@email.com',       '3331234563'),
('Elena',      'Russo',     '1995-02-18', 'F', 'elena.russo@email.com',      '3331234564'),
('Marco',      'Ferrari',   '1982-09-30', 'M', 'marco.ferrari@email.com',    '3331234565'),
('Giulia',     'Esposito',  '2001-05-14', 'F', 'giulia.esposito@email.com',  '3331234566'),
('Francesco',  'Romano',    '1969-12-25', 'M', 'francesco.romano@email.com', '3331234567'),
('Sofia',      'Colombo',   '1998-08-09', 'F', 'sofia.colombo@email.com',    '3331234568'),
('Alessandro', 'Ricci',     '1988-04-03', 'M', 'alessandro.ricci@email.com', '3331234569'),
('Francesca',  'Marini',    '1993-10-27', 'F', 'francesca.marini@email.com', '3331234570');
...
ALTER TABLE utenti ADD COLUMN luogo_nascita VARCHAR(255);
SELECT CONCAT('Utenti: ',    COUNT(*)) AS verifica FROM utenti

UNION ALL
SELECT CONCAT('Autori: ',    COUNT(*)) FROM autori
UNION ALL
SELECT CONCAT('Libri: ',     COUNT(*)) FROM libri
UNION ALL
