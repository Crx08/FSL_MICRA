...
// node_modules/tree/tree.js
var require_tree = __commonJS({
  "node_modules/tree/tree.js"(exports) {
    (function() {
      var Tree;
      ...
      Tree.VERSION = "0.1.2";
      var _3 = this._;
      if (!_3 && typeof __require !== "undefined") {
      ...
      Tree.Node = function(children, data) {
        ...
        this.data = data || {};
        this.branch = null;
        this.id = this.data.id || _3.uniqueId("n");
      };
      _3.extend(Tree.Node.prototype, {
      ...
      _3.extend(Tree.Branch.prototype, {
        ...
        remove: function(node) {
          this.nodes = _3.reject(this.nodes, function(n) {
            return n.id == node.id;
          });
          node.branch = null;
          return node;
      ...
      _3.extend(Tree.Root.prototype, {
        // Find the node with the given ID (BFS).
        find: function(id) {
          var queue = [];
          _3.each(this.branch.nodes, function(node2) {
            queue.push(node2);
          });
          while (queue.length > 0) {
            ...
            if (id == node.id) {
              ...
              _3.each(node.children.nodes, function(node2) {
                queue.push(node2);
              });
            }
          }
...
// node_modules/tree/index.js
var require_tree2 = __commonJS({
  "node_modules/tree/index.js"(exports, module) {
    module.exports = require_tree();
  }
});
export default require_tree2();
